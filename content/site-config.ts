export const siteConfig = {
  ...
  organizerEmail: "events@mathabah.org",
  supportEmail: "events@mathabah.org",
  ...
  socialLinks: {
    ...
    email: "mailto:events@mathabah.org",
  },
  hero: {
